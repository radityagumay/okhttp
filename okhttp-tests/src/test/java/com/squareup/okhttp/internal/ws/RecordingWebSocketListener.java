...
public final class RecordingWebSocketListener implements WebSocketListener {
  ...
  public Message takeMessage() {
    return (Message) events.removeFirst();
  }

  public Close takeClose() {
    return (Close) events.removeFirst();
  }

  public IOException takeFailure() {
    return (IOException) events.removeFirst();
  }
}
